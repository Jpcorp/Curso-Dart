...
ReqRespRestCountry reqRespRestCountryFromJson(String str) => ReqRespRestCountry.fromJson(json.decode(str));

String reqRespRestCountryToJson(ReqRespRestCountry data) => json.encode(data.toJson());

class ReqRespRestCountry {
    ReqRespRestCountry({
        required this.name,
    ...
    factory ReqRespRestCountry.fromJson(Map<String, dynamic> json) => ReqRespRestCountry(
        name: json["name"],
...
class RegionalBloc {
    ...
    factory RegionalBloc.fromJson(Map<String, dynamic> json) => RegionalBloc(
        ...
        otherAcronyms: json["otherAcronyms"] == null ? <String>[] : new List<String>.from(json["otherAcronyms"].map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "otherAcronyms": otherAcronyms == null ? <String>[] : new List<dynamic>.from(otherAcronyms.map((x) => x)),
    };
}
