...
void stout(dynamic msg) => stdout.writeln(msg);


String stdins() => stdin.readLineSync() ?? '';
...
main() {
  ...
  stout('¿Cúal es su nombre?');
  String nombre = stdins();

  stout('¿Qué edad tienes?');
  String edad = stdins();
  
  stout('¿En qué país naciste?');
  String pais = stdins();
  ...
  stout('Usuario 1 sin deducciones');
  stout( usuario );
